...
class inventory_app extends application
{
	function inventory_app()
	{
		...
		$this->add_lapp_function(1, _("Inventory Item &Movement Reports"),
			"inventory/inquiry/stock_movements.php?", 'SA_ITEMSTRANSVIEW', MENU_INQUIRY);
		$this->add_lapp_function(1, _("Inventory Item &Status Reports"),
			"inventory/inquiry/stock_status.php?", 'SA_ITEMSSTATVIEW', MENU_INQUIRY);
		$this->add_rapp_function(1, _("Inventory and Location &Reports"),
		...
		$this->add_lapp_function(2, _("Add and Manage Inventory &Locations"),
		...
		$this->add_rapp_function(2, _("Add and Manage &Units of Measure"),
			"inventory/manage/item_units.php?", 'SA_UOM', MENU_MAINTENANCE);
		$this->add_rapp_function(2, _("Manage Inventory &Reorder Levels"),
