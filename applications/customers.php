...
class customers_app extends application 
{
	function customers_app() 
	{
		...
		$this->add_rapp_function(0, _("Make &Customer Payments"),
		...
		$this->add_lapp_function(1, _("Sales Booking/Order &Report"),
			"sales/inquiry/sales_orders_view.php?type=30", 'SA_SALESTRANSVIEW', MENU_INQUIRY);
		$this->add_lapp_function(1, _("Customer Invoice &Report"),
