...
class general_ledger_app extends application
{
	function general_ledger_app()
	{
		...
		$this->add_lapp_function(0, _("Make &Receipts/Deposits"),
		...
		$this->add_lapp_function(1, _("View all &Journal Reports"),
			"gl/inquiry/journal_inquiry.php?", 'SA_GLANALYTIC', MENU_INQUIRY);
		$this->add_lapp_function(1, _("Single Ledger &Reports"),
			"gl/inquiry/gl_account_inquiry.php?", 'SA_GLTRANSVIEW', MENU_INQUIRY);
		$this->add_lapp_function(1, _("Bank Account &Reports"),
			"gl/inquiry/bank_inquiry.php?", 'SA_BANKTRANSVIEW', MENU_INQUIRY);
		$this->add_lapp_function(1, _("Ta&x Reports"),
		...
		$this->add_lapp_function(1, _("Bank &Statements"),
			"reporting/reports_main.php?Class=5", 'SA_BANKREP', MENU_REPORT);
		$this->add_rapp_function(1, _("Accounts &Reports"),
			"reporting/reports_main.php?Class=6", 'SA_GLREP', MENU_REPORT);

		$this->add_module(_("Maintenance"));
		$this->add_lapp_function(2, _("Add and Manage Bank &Accounts"),
		...
		$this->add_rapp_function(2, _("&Add and Manage GL Accounts"),
